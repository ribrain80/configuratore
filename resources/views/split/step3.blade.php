...
@section( "content" )
    ...
    <form action='{{ route( "split.step4" ) }}' method="POST" v-on:submit.prevent="checkChoice" id="drawertypes">
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="input-group input-group-lg col-lg-3">
                        ...
                        <input type="text" class="form-control" id="length" aria-describedby="basic-addon3"
                               v-model.lazy="length" v-on:keyup="updateDrawer">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-lg col-lg-3">
                        ...
                        <input type="text" class="form-control" id="width" aria-describedby="basic-addon3"
                               v-model.lazy="width" v-on:keyup="updateDrawer">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-group input-group-lg col-lg-3">
                        ...
                        <input type="text" class="form-control" id="depth" aria-describedby="basic-addon3"
                               v-model.lazy="depth" v-on:keyup="updateShoulder">
                    </div>
        ...
        <div class="row">
            <div class="col-lg-3"><input lang="it" type="submit" id="step2-next" class="btn btn-info" value="Avanti"/>
            </div>
        </div>
    </form>
        ...
        var step2 = new Vue({
                ...
                methods: {
                    ...
                    inittwo: function () {
                        ...
                        let line = this.two.makeLine(this.two.width / 2 - 30, this.two.height / 2 - 60, this.two.width / 2 + 30, this.two.height / 2 - 60);
                        line.stroke = '#000000';
